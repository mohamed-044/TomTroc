...
<section class="edit-section">
    <a class="author" id="back" href="/TomTroc/views/templates/exchangeBooks.php">&#8592; Retour</a>
    <h1 class="title5">Modifier les informations</h1>
    <div class="edit-content">
        <div class="edit-image">
        <label class="author" for="book_image" id="book_image">Photo</label>
        <img id="edit_book_image" src="/TomTroc/img/hero_image.jpg" alt="Detail Book Image">
